...
class mymodel(torch.nn.Module):
    ...
    def forward(self, x):
        ...
        return detetion_out_13, detetion_out_26, detetion_out_52#,convset_out_13,h_13

if __name__ == '__main__':
    yolo = mymodel().to('cuda')
    x = torch.randn(1,3,416,416).cuda()
    # summary(yolo,input_size=[(3,416,416)],device='cuda')
    macs, params = profile(yolo, inputs=(x,))
