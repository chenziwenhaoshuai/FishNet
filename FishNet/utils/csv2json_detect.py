import json
file = "../json_output/detect.csv"
jsonpath = "../dataset_test/annotations/detect_label.json" # 标签
# label_path = "./labels/"
# labelsss = []
output = {}
name = set()
...
with open(file, 'r') as csv:
        ...
        if len(line)>3:
            ...
            for lines in images:
                if file_name == lines["file_name"]:
                    ...
                    w = int(line[5])-int(line[3])
                    h = int(line[6])-int(line[4])
                    kuang = {"image_id":id,"category_id":cls,"bbox":[x,y,w,h],"score":conf}
    ...
    with open('../json_output/detect.json', 'a') as json:
